...
import com.thehecklers.aircraftpositions.PositionController;

import main.java.com.thehecklers.aircraftpositions.PositionRetriever;
...
public class PositionControllerTest {
    ...
    void getCurrentAircraftPositions(@Autowired WebTestClient client) {
        final List<Aircraft> acPositions = client.get()
                .uri("/aircraft")
                .exchange()
                .expectStatus().isOk()
